...
tabPanel(strong("Partners"),
         ...
         div(tags$head(
             ...
             column(width=12, h5("Sama Al Yaman Development Foundation",icon("check", "fa-2x")), a(img(src='0_sama.jpg', height= "50px", style='padding:1px;border:thin solid black;'),target="_blank", href="http://www.samaalyemen.org/")),
